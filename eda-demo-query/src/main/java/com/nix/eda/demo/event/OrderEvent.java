...
public class OrderEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public OrderEvent(java.util.UUID orderId, java.util.UUID id, java.lang.Long timestamp, com.nix.eda.demo.event.EventType type, java.util.List<com.nix.eda.demo.event.Attribute> attributes) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: type = (com.nix.eda.demo.event.EventType)value$; break;
    case 4: attributes = (java.util.List<com.nix.eda.demo.event.Attribute>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderEvent>
    ...
    /**
      ...
      * @return This builder.
      */
    public com.nix.eda.demo.event.OrderEvent.Builder setOrderId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.nix.eda.demo.event.OrderEvent.Builder clearOrderId() {
      orderId = null;
    ...
    public OrderEvent build() {
      try {
        ...
        record.type = fieldSetFlags()[3] ? this.type : (com.nix.eda.demo.event.EventType) defaultValue(fields()[3]);
        record.attributes = fieldSetFlags()[4] ? this.attributes : (java.util.List<com.nix.eda.demo.event.Attribute>) defaultValue(fields()[4]);
        return record;
